...
class HighlightView {
    ...
    public void setup(Matrix m, Rect imageRect, RectF cropRect, boolean maintainAspectRatio) {
        ...
        cornerPaint.setStrokeWidth(3*outlineWidth);
        cornerPaint.setColor(highlightColor);
    ...
    private void drawHandles(Canvas canvas) {
        ...
        canvas.drawLine(drawRect.left,drawRect.top,drawRect.left+2*handleRadius,drawRect.top,cornerPaint);
        canvas.drawLine(drawRect.left,drawRect.top,drawRect.left,drawRect.top+2*handleRadius,cornerPaint);

        canvas.drawLine(drawRect.right,drawRect.top,drawRect.right-2*handleRadius,drawRect.top,cornerPaint);
        canvas.drawLine(drawRect.right,drawRect.top,drawRect.right,drawRect.top+2*handleRadius,cornerPaint);

        canvas.drawLine(drawRect.left,drawRect.bottom,drawRect.left+2*handleRadius,drawRect.bottom,cornerPaint);
        canvas.drawLine(drawRect.left,drawRect.bottom,drawRect.left,drawRect.bottom-2*handleRadius,cornerPaint);

        canvas.drawLine(drawRect.right,drawRect.bottom,drawRect.right-2*handleRadius,drawRect.bottom,cornerPaint);
        canvas.drawLine(drawRect.right,drawRect.bottom,drawRect.right,drawRect.bottom-2*handleRadius,cornerPaint);
    }
