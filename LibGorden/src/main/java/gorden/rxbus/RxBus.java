...
public class RxBus {
    ...
    private void addSubscriptionToMap(Class eventType, Disposable disposable) {
        ...
        XLog.e(RxBus.LOG_BUS, "当前注册RXBUS:" + subscriptionsByEventType);
    }
    ...
    private void callEvent(SubscriberMethod method, Object object) {
        ...
        XLog.e(LOG_BUS," RxBus接收到  " +object+"   "+method.code+"    "+method.subscriber+"    "+method.method);
        ...
        if (subscriberMethods != null) {
            ...
            while (iterator.hasNext()) {
                ...
                if (subscriberMethod.subscriber.equals(subscriber)) {
                    XLog.e(RxBus.LOG_BUS, "RxBus 取消注册 :" + eventType + "  -----  " + subscriber);
                    iterator.remove();
                }
            }
        }
