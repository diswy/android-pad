...
public class NiftyIndicator {
    ...
    private float mResistance = 2.7f;
    private float mCurrentResistance=2.7f;
    ...
    protected void processOnMove(float currentX, float currentY, float offsetX, float offsetY) {
        setOffset(offsetX, offsetY / mCurrentResistance);
    }
    ...
    public final void onMove(float x, float y) {
        ...
        mCurrentResistance=mCurrentPos/(2*mHeaderHeight)*5+mResistance;
    ...
    public void convertFrom(NiftyIndicator ptrSlider) {
