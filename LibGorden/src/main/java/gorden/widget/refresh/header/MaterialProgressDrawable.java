...
public class MaterialProgressDrawable extends Drawable implements Animatable {
    ...
    private void setUp(final double diameter) {
        DensityUtil densityUtil = new DensityUtil(mParent.getContext());
        final int shadowYOffset = densityUtil.dip2px((int) Y_OFFSET);
        final int shadowXOffset = densityUtil.dip2px((int) X_OFFSET);
        int mShadowRadius = densityUtil.dip2px((int) SHADOW_RADIUS);
