 ...
 */
class GatewayInterceptor(val appKey:String,val appSecret:String) : Interceptor {
    ...
    private fun buildReq(request: Request): Request {
         ...
         */
        //        String pathWithPathParameter = this.combinePathParam(request.url().host() , request.body());
