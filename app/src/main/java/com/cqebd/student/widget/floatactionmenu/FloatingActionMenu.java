package com.cqebd.student.widget.floatactionmenu;
...
import com.cqebd.student.widget.floatactionmenu.animation.DefaultAnimationHandler;
import com.cqebd.student.widget.floatactionmenu.animation.MenuAnimationHandler;
...
public class FloatingActionMenu {
    ...
    public View getActivityContentView() {
        try {
            return ((AppCompatActivity) context).getWindow().getDecorView().findViewById(android.R.id.content);
        }
