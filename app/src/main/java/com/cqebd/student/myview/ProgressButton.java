package com.cqebd.student.myview;
...
import com.xiaofu.lib_base_xiaofu.fancy.MeasureHelperKt;
...
public class ProgressButton extends AppCompatButton {
    ...
    private void initialize(Context context, AttributeSet attrs) {
        ...
        try {
            mBorderColor = attr.getColor(R.styleable.ProgressButton_borderColor,Color.parseColor("#000000"));
            mBorderWidth = (int) attr.getDimension(R.styleable.ProgressButton_borderWidth,0);
            ...
            mDrawableButton.setStroke(mBorderWidth, mBorderColor);
            ...
            mDrawableProgressBackground.setStroke(mBorderWidth, mBorderColor);
