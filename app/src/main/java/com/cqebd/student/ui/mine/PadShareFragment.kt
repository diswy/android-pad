...
import kotlinx.android.synthetic.main.fragment_pad_share.*
 ...
 *
 */
class PadShareFragment : BaseFragment() {
    ...
    override fun setContentView(inflater: LayoutInflater?, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        return inflater?.inflate(R.layout.fragment_pad_share, container, false)
    }
